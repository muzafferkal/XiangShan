...
class ICacheMainPipe(implicit p: Parameters) extends ICacheModule {
  ...
  val s0_flush_from_bpu_s2 = s0_valid && io.fetch.flushFromBpu.shouldFlushByStage2(s0_req_ftqIdx)
  val s0_flush_from_bpu_s3 = s0_valid && io.fetch.flushFromBpu.shouldFlushByStage3(s0_req_ftqIdx)
  s0_flush := io.flush || s0_flush_from_bpu_s2 || s0_flush_from_bpu_s3 || s1_flush
  ...
  val s1_flush_from_bpu_s3 = s1_valid && io.fetch.flushFromBpu.shouldFlushByStage3(s1_req_ftqIdx)
